...
Some of the consonant rows can be applied a *dakuten* mark denoted by ( ゛) to become voiced consonants. This changes the sound of the consonant:
- k --> g
- s --> z 
- t --> d
- h --> b
...
| g   | が   | ぎ       | ぐ        | げ   | ご   |
| z   | ざ   | じ<br>ji | ず        | ぜ   | ぞ   |
| d   | だ   | ぢ<br>ji | づ<br>dzu | で   | ど   |
| b   | ば   | び       | ぶ        | べ   | ぼ   |

The H-row of the Hiragana table can also be given a *handakuten* mark denoted by ( ゜). This changes the sound of the consonant:
- h --> p
...
The Y-row characters have what is called the "small" version which can be added to Hiragana characters ending in -i, each replacing the -i postfix with itself
